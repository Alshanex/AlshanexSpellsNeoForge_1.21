...
public class EndStoneEntity extends AbstractMagicProjectile {

    public EndStoneEntity(EntityType<? extends Projectile> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.setNoGravity(true);
    }

    public EndStoneEntity(Level pLevel, LivingEntity owner) {
        this(ModEntities.END_STONE_ENTITY.get(), pLevel);
        this.setOwner(owner);
    }

...
public class PurpurBricksEntity extends AbstractMagicProjectile {

    public PurpurBricksEntity(EntityType<? extends Projectile> pEntityType, Level pLevel) {
        super(pEntityType, pLevel);
        this.setNoGravity(true);
    }

    public PurpurBricksEntity(Level pLevel, LivingEntity owner) {
        this(ModEntities.PURPUR_BRICKS_ENTITY.get(), pLevel);
        this.setOwner(owner);
    }
